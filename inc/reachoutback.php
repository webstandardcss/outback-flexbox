...
$yourEmail = "webstandardcss@gmail.com"; // the email address you wish to receive these mails through
$yourWebsite = "Outback Feeders"; // the name of your website
$thanksPage = '//outbackfeeders.com'; // URL to 'thanks for sending mail' page; leave empty to keep message on the same page 
...
<?php // <p>Powered by <a href="http://jemsmailform.com/">Jem's PHP Mail Form</a></p> ?>
